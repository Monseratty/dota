...
tasks.register<JavaExec>("runFullDemoDump") {
    group = "clarity tools"
    description = "Dump replay summary, scoreboard, combat log and game events as JSON/JSONL."
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("skadistats.clarity.tools.FullDemoDump")
}

tasks.register<JavaExec>("runFinalInventoryDump") {
    group = "clarity tools"
    description = "Dump final hero inventories as JSON."
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("skadistats.clarity.tools.FinalInventoryDump")
}

tasks.register<JavaExec>("runSkillBuildDump") {
    group = "clarity tools"
    description = "Dump exact ability level changes as JSONL."
    classpath = sourceSets["main"].runtimeClasspath
...
tasks.register<JavaExec>("runAbilityProbe") {
    ...
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("skadistats.clarity.tools.AbilityProbe")
}
